...
export interface AnchorInfo {
  ...
  /** Deposits worth at or below this are confirmed without anyone pressing anything; the same figure in both currencies. */
  autoConfirm?: { usd: number; try: number; rateUsed: number };
